...
function teglalapKeruletTerulet(a, b, funkcio){
    ...
    console.log(teglalapKeruletTerulet (5,4, 'gjhghj'));*/
...
var belaHivatalosReggeli = odon.udvozlet.bind(bela, 'hivatalos', 'reggeli');
...
var korok = tobbMuvelet(evek, korszamitas);
console.log(evek);
console.log(kork);

var felnottkorJapanban = tobbMuvelet (korok, felnott.bind(this, 20));
